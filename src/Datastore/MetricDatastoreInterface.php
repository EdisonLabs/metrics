...
interface MetricDatastoreInterface
{
     ...
     *
     * @param string $date   The date of the metrics (timestamp).
     * @param array  $config An array containing the config.
     */
     ...
     *
     * @return string The metric datastore name.
     */
     ...
     *
     * @return string The metric datastore description.
     */
     ...
     *
     * @param array $config An array containing the datastore config.
     */
     ...
     *
     * @return array An array containing the datastore config.
     */
     ...
     *
     * @param string $date The date of the metrics.
     */
