...
interface MetricInterface
{
     ...
     *
     * @param string $date   The metric date (timestamp).
     * @param array  $config An array containing the metric config.
     */
     ...
     *
     * @param array $config An array containing the metrics config.
     */
     ...
     *
     * @return array An array containing the metrics config.
     */
     ...
     *
     * @param string $date The date of the metric.
     */
